...
//	rt_thread_init(&das_thread,					//线程控制块
//                   "das_thread",				//线程控制块名字
//                   das_thread_entry,			//线程入口函数
//                   RT_NULL,						//线程入口函数的参数
//                   &das_thread_stack[0],		//线程栈起始地址
//                   sizeof(das_thread_stack),	//线程栈大小
//                   DAS_THREAD_PRIORITY, 		//线程优先级
//									 DAS_THREAD_TIMESLICE);		//线程时间片大小
...
//	rt_thread_init(&order_thread,					//线程控制块
//                   "order_thread",					//线程控制块名字
//                   order_thread_entry,				//线程入口函数
//                   RT_NULL,							//线程入口函数的参数
//                   &order_thread_stack[0],			//线程栈起始地址
//                   sizeof(order_thread_stack),		//线程栈大小
//                   ORDER_THREAD_PRIORITY, 			//线程优先级
//									 ORDER_THREAD_TIMESLICE);			//线程时间片大小	
...
//	rt_thread_init(&wdi_thread,					//线程控制块
//                   "wdi_thread",					//线程控制块名字
//                   wdi_thread_entry,				//线程入口函数
//                   RT_NULL,							//线程入口函数的参数
//                   &wdi_thread_stack[0],			//线程栈起始地址
//                   sizeof(wdi_thread_stack),		//线程栈大小
//                   WDI_THREAD_PRIORITY, 			//线程优先级
//									 WDI_THREAD_TIMESLICE);		//线程时间片大小
